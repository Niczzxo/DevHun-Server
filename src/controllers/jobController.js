...
const getJobs = async (req, res) => {
  ...
  try {
    ...
    const total = await db.jobsCollection.countDocuments(query);

    // Fetch jobs
    const jobs = await db.jobsCollection
      .find(query)
      .sort(sortObj)
      .skip(skipNum)
      .limit(limitNum)
...
const getUserJobs = async (req, res) => {
  ...
  try {
    const result = await db.jobsCollection.find(query).toArray();
...
const postJob = async (req, res) => {
  ...
  try {
    const result = await db.jobsCollection.insertOne(newJob);
...
const getJobById = async (req, res) => {
  ...
  try {
    const result = await db.jobsCollection.findOne(query);
    res.send({
      success: true,
...
const updateJobById = async (req, res) => {
  ...
  try {
    const result = await db.jobsCollection.updateOne(query, update);
...
const deleteJobById = async (req, res) => {
  ...
  try {
    const result = await db.jobsCollection.deleteOne(query);
